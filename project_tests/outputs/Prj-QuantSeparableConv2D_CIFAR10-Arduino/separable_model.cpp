...
batch_normalization_layer_t init_batch_normalization_394_data(void){
    ...
    -0.23298127949237823, -0.1387329399585724, -0.8143776059150696, 0.3523108661174774, 
    -0.04030158743262291, -1.4509506225585938, -0.2011227309703827, -0.9447472095489502, 
    0.49902400374412537, -1.1087024211883545, -1.166777491569519, -0.2244957834482193, 
    -0.9862293601036072, -0.4208996891975403, -0.5210910439491272, 0.7248897552490234, 
  
    };
    static const float mov_mean[] ={
    0.11284785717725754, 0.02766709215939045, 0.051500122994184494, 0.05118296295404434, 
    0.05934419482946396, 0.07928131520748138, 0.11022435873746872, 0.08770714700222015, 
    0.055307868868112564, 0.13425646722316742, 0.0581497959792614, 0.09336152672767639, 
    0.029826370999217033, 0.06707237660884857, 0.10282889008522034, 0.04535624384880066, 
...
batch_normalization_layer_t init_batch_normalization_395_data(void){
    ...
    static const float beta[] ={
    1.0616419315338135, -0.012498131953179836, -0.20619377493858337, 0.0683060884475708, 
    0.005514976102858782, -0.010063054971396923, 0.043569713830947876, 0.15887759625911713, 
    -0.4738259017467499, 0.2919153571128845, 0.2869112491607666, 0.051964253187179565, 
    -0.1153615191578865, 0.18144725263118744, -0.01814410276710987, -0.27276360988616943, 
    0.2236650139093399, -0.23476241528987885, -0.08559228479862213, -0.5334243178367615, 
    -0.038635022938251495, -0.48519402742385864, 0.1560736447572708, 0.03722354397177696, 
    -0.053322285413742065, -0.14703504741191864, 0.4583789110183716, 0.06625976413488388, 
    -0.019109217450022697, 0.2698938548564911, -0.11979348957538605, -0.6460927724838257, 
    -0.0040063923224806786, 0.5189810991287231, 0.16088582575321198, -0.2953907251358032, 
    -0.7148451209068298, -0.10178370773792267, -0.07514631748199463, -0.14898233115673065, 
    0.06733419001102448, 0.16164326667785645, 0.3031226098537445, 0.10753902047872543, 
    0.5190198421478271, -0.6142810583114624, -0.19352877140045166, 0.027290932834148407, 
    -0.4863969385623932, 0.03572480380535126, -0.029375556856393814, 0.8162729144096375, 
    -0.4896080195903778, 0.09718995541334152, -1.5990583896636963, 0.13757120072841644, 
    -0.08679575473070145, -0.5372229814529419, 0.09318296611309052, -0.2686939239501953, 
    0.010862850584089756, -0.0632207989692688, 0.4525291621685028, 0.17404791712760925, 
  
    };
    static const float mov_mean[] ={
    -2.048846483230591, -6.092587947845459, 3.1136200428009033, -2.9979512691497803, 
    0.19347228109836578, 6.830169677734375, 2.104797601699829, -10.721678733825684, 
    2.271303176879883, 2.6061794757843018, -3.531564950942993, -1.4758248329162598, 
    6.529369354248047, 5.616878032684326, 7.0486226081848145, 6.587652683258057, 2.2867465019226074, 
    -2.3239688873291016, -11.006747245788574, -5.437778472900391, 11.211670875549316, 
    2.2781059741973877, -4.603123664855957, 5.887838363647461, 7.134128093719482, -5.167169570922852, 
    0.6022427678108215, -6.8137640953063965, 1.940039038658142, -1.9879772663116455, 
    2.7543957233428955, 4.377793312072754, -0.2959326207637787, 4.986171722412109, 6.829707622528076, 
    -0.03458103910088539, -2.7966346740722656, -0.670536458492279, -2.600364923477173, 
    -1.3909868001937866, 3.1264257431030273, 0.9827348589897156, 1.8315714597702026, 
    2.39736008644104, 5.70461893081665, -4.40537691116333, -10.206701278686523, 4.094964504241943, 
    -3.4720377922058105, 8.780932426452637, -1.01392662525177, 5.985422611236572, -0.2545253336429596, 
    11.482803344726562, 1.5928635597229004, 0.8929404020309448, -4.6184186935424805, 
    5.918550491333008, 4.0242767333984375, -13.27382755279541, -4.4947052001953125, 
    2.7439768314361572, 6.000952243804932, -2.166691541671753
    };
    static const float inv_gamma_dev[] ={
...
batch_normalization_layer_t init_batch_normalization_396_data(void){
    ...
    static const float beta[] ={
    -0.1173904612660408, 0.587567150592804, -0.31313300132751465, 0.1279149204492569, 
    -0.19607889652252197, -0.09170190989971161, 0.16417530179023743, 0.2401694655418396, 
    -0.07726088911294937, 0.13244792819023132, 0.005817211698740721, -0.14517557621002197, 
    0.5044105648994446, -0.18036119639873505, 0.08867348730564117, 0.09390347450971603, 
    -0.01527482084929943, 0.07469325512647629, 0.19009903073310852, 0.09999604523181915, 
    0.671714186668396, 0.0800580307841301, 0.23321479558944702, 0.3643728494644165, 
    0.28719058632850647, -0.31657806038856506, -0.0013981228694319725, -0.4312017261981964, 
    0.3317744731903076, -0.13501781225204468, -0.042609889060258865, 0.12038806825876236, 
    -0.10647246241569519, 0.15752972662448883, 0.08885103464126587, 0.7901297211647034, 
    -0.18837520480155945, 0.13663886487483978, -0.1389797329902649, 0.15875864028930664, 
    -0.27798980474472046, 0.09141895174980164, -0.07457147538661957, 0.14539071917533875, 
    -0.08100199699401855, -0.25151878595352173, -0.12051389366388321, 0.48671382665634155, 
    -0.04915453493595123, 0.17663441598415375, -0.07257302105426788, 0.08808980137109756, 
    -0.025987880304455757, 0.35916632413864136, 0.15842440724372864, -0.2231435626745224, 
    -0.17948822677135468, 0.01547736581414938, -0.11044227331876755, -0.20544862747192383, 
    0.3770877718925476, 0.21954455971717834, -0.3197910785675049, -0.37168097496032715, 
    -0.08355724066495895, -0.2268066257238388, 0.23912359774112701, 0.3110882639884949, 
    -0.18010213971138, 0.14375145733356476, 0.12733326852321625, 0.07583975046873093, 
    -0.06577463448047638, -0.08201272040605545, -0.28000539541244507, 0.23147037625312805, 
    -0.3066948652267456, 0.18088608980178833, 0.03018546849489212, -0.033604249358177185, 
    -0.20270667970180511, 0.02979305200278759, 0.2917384207248688, 0.07763189822435379, 
    0.32030072808265686, 0.13130038976669312, 0.16419820487499237, 0.7521756291389465, 
    -0.24460572004318237, -0.24338600039482117, -0.4161248505115509, -0.023838253691792488, 
    0.12571538984775543, 0.0106205428019166, 0.483015239238739, 0.3527994751930237, 
  
    };
    static const float mov_mean[] ={
    3.070204019546509, 20.33562660217285, 2.3468923568725586, 4.400020122528076, 25.93905258178711, 
    18.063859939575195, 14.892305374145508, 15.723467826843262, 28.60617446899414, 13.538617134094238, 
    30.711973190307617, 16.512676239013672, 3.159323215484619, 20.639781951904297, 8.42900562286377, 
    21.065765380859375, 8.766740798950195, 31.770305633544922, 12.911551475524902, 23.423398971557617, 
    19.10860252380371, 7.118557929992676, 17.54496955871582, 12.485995292663574, 30.4399356842041, 
    21.143218994140625, 9.725631713867188, 18.579822540283203, 19.0754451751709, 26.00106430053711, 
    6.337032318115234, 8.962132453918457, 35.79444122314453, 21.838844299316406, 14.314400672912598, 
    9.155838012695312, 14.272759437561035, 10.551871299743652, 12.650069236755371, 15.585748672485352, 
    5.8605170249938965, 17.11336898803711, 15.985185623168945, 24.662418365478516, 17.5478572845459, 
    22.70379066467285, 6.520959377288818, 21.1684627532959, 26.394617080688477, 20.752010345458984, 
    27.037750244140625, -11.76386833190918, 10.981718063354492, 30.057109832763672, 
    16.585365295410156, 13.193221092224121, 7.679944038391113, 21.11290168762207, 11.32365608215332, 
    3.6263351440429688, 4.2095866203308105, 7.451915740966797, 12.846603393554688, 29.56100845336914, 
    9.17735481262207, 19.000625610351562, 18.08026885986328, 19.940750122070312, 5.27767276763916, 
    16.521989822387695, 16.34976577758789, 12.796062469482422, 10.167465209960938, 26.65730857849121, 
    10.643170356750488, 36.34708786010742, 10.75222396850586, 26.13722038269043, 2.360764980316162, 
    4.916474342346191, 18.48418617248535, 23.910728454589844, 7.338948726654053, 16.656076431274414, 
    18.098093032836914, 14.6603364944458, 22.277545928955078, 29.169099807739258, 2.741220235824585, 
    12.332289695739746, 24.266220092773438, 31.13119125366211, 19.922378540039062, 1.2846547365188599, 
    28.134546279907227, 36.10281753540039
    };
    static const float inv_gamma_dev[] ={
    ...
    static const batch_normalization_layer_t norm = { 96, beta, mov_mean, inv_gamma_dev };
    return norm;
}
...
batch_normalization_layer_t init_batch_normalization_397_data(void){
    ...
    static const float beta[] ={
    -0.003553137881681323, -0.11398154497146606, -0.2449309527873993, -0.9171269536018372, 
    0.4142596125602722, 0.4975353181362152, 0.022537963464856148, -0.3273439109325409, 
    -0.17673005163669586, -0.24833077192306519, -0.0859692245721817, -0.09684571623802185, 
    -0.303699791431427, -0.21807296574115753, 0.11255404353141785, -0.030381685122847557, 
    -0.2834721505641937, -0.1576758474111557, 0.26800793409347534, 0.015307921916246414, 
    -0.04089396819472313, 0.48867905139923096, 0.12748181819915771, 0.06794226914644241, 
    0.005784113425761461, -0.5482337474822998, 0.026821669191122055, -0.18649688363075256, 
    0.02193777821958065, -0.03429180383682251, -0.25239452719688416, -0.5493284463882446, 
    0.027767004445195198, -0.4672919809818268, -0.218453049659729, -0.35066887736320496, 
    0.05161742866039276, -0.39400702714920044, -0.13253289461135864, 0.09838100522756577, 
    0.43547922372817993, 0.06728776544332504, -0.04292749613523483, -0.0003720733802765608, 
    -0.5747523903846741, -0.12659503519535065, -0.1914788782596588, -0.2851053476333618, 
    -0.2966069281101227, 0.42879125475883484, -0.15575967729091644, 0.09375948458909988, 
    -0.08899708092212677, 0.12992791831493378, 0.050896722823381424, 0.251274973154068, 
    -0.18258000910282135, -0.5384538769721985, 0.22187213599681854, -0.05283410847187042, 
    -0.34664249420166016, 0.2730483114719391, 0.03711691126227379, 0.3133498728275299, 
    -0.3842129409313202, -0.02013804018497467, -0.11275847256183624, 0.15156100690364838, 
    -0.010633597150444984, 0.1318700760602951, 0.10332811623811722, 0.5049284100532532, 
    0.3090771734714508, 0.5416675806045532, 0.3627798855304718, 0.007999098859727383, 
    -0.4162471294403076, -0.06217039003968239, 0.1750594973564148, 0.17870192229747772, 
    -0.15233732759952545, 0.09770801663398743, -0.31382501125335693, 0.07798363268375397, 
    0.057090915739536285, -0.03590221330523491, -0.09613854438066483, 0.05583231896162033, 
    0.06171130761504173, 0.05472373962402344, -0.7018480896949768, -0.04674800857901573, 
    0.32822391390800476, 0.07924486696720123, 0.049275562167167664, 0.6806648969650269, 
    -0.026626499369740486, 0.0986991673707962, -0.10868535935878754, -0.16859601438045502, 
    0.027007518336176872, 0.12150997668504715, 0.1882891058921814, 0.05020681396126747, 
    -0.19822649657726288, 0.022343114018440247, 0.21238122880458832, -0.007910440675914288, 
    -0.16122516989707947, 0.03895699977874756, -0.0968877300620079, 0.4651172459125519, 
    0.06713806092739105, 0.22710596024990082, -0.22190168499946594, 0.03852491080760956, 
    -0.25918927788734436, 0.19625258445739746, 0.15833048522472382, 0.06771275401115417, 
    -0.03478377312421799, 0.32340121269226074, -0.07866217941045761, 0.2460559457540512, 
    -0.07608456164598465, 0.03604371100664139, 0.09419392049312592, 0.1564750075340271, 
    -0.17849409580230713, 0.01578899286687374, -0.227905735373497, 0.19249188899993896, 
    -0.1940915286540985, 0.4229413568973541, -0.06394462287425995, -0.07994971424341202, 
    -0.3897619843482971, 0.048012953251600266, 0.3774605095386505, 0.3559874892234802, 
    0.23089423775672913, 0.34317779541015625, 0.13706298172473907, 0.013019273988902569, 
    -0.09957296401262283, 0.2170417755842209, -0.4306928217411041, -0.027958644554018974, 
    -0.16731467843055725, 0.500826358795166, 0.007919984869658947, 0.15751062333583832, 
    0.2894989252090454, 0.046250585466623306, -0.13801465928554535, -0.11579933017492294, 
    0.37778469920158386, -0.4853879511356354, -0.05175082013010979, -0.49428942799568176, 
    0.009198199026286602, 0.29134851694107056, -0.22139044106006622, -0.22041654586791992, 
    0.08581597357988358, 0.17212796211242676, -0.033216025680303574, -0.1839551329612732, 
    0.08911647647619247, -0.04727531969547272, 0.11153095960617065, -0.27094364166259766, 
    -0.030915139243006706, 0.08361109346151352, 0.17855249345302582, -0.1419871747493744, 
    0.15179362893104553, -0.327638179063797, -0.014237852767109871, -0.5828046798706055, 
    0.23741884529590607, -0.32241740822792053, -0.03285150229930878, 0.25655683875083923, 
    -0.32109320163726807, -0.3814246654510498, -0.2228493094444275, 0.03483708202838898, 
    0.013682948425412178, -0.003870346350595355, -0.22534236311912537, -0.009906529448926449, 
    -0.28590524196624756, -0.13317109644412994, -0.019113073125481606, 0.04586661607027054, 
    -0.1452457457780838, -0.4110611081123352, -0.09494571387767792, 0.49586236476898193, 
    -0.2576393485069275, -0.23953454196453094, -0.41602829098701477, -0.3125635087490082, 
    0.07417770475149155, 0.3484819531440735, 0.23324303328990936, -0.14189119637012482, 
    0.27508026361465454, -0.3260176479816437, 0.2742576599121094, 0.5706040263175964, 
    -0.22777442634105682, 0.2652163505554199, 0.18390287458896637, -0.07365673035383224, 
    0.17603163421154022, 0.3210759460926056, -0.48088955879211426, -0.07473575323820114, 
    -0.6564165353775024, -0.12514902651309967, 0.09593268483877182, 0.034276969730854034, 
    -0.062021300196647644, 0.19600321352481842, 0.4443050026893616, 0.4479777216911316, 
    0.19967582821846008, 0.2038712203502655, 0.20181633532047272, 0.39333295822143555, 
    -0.30670365691185, -0.17094078660011292, 0.30915939807891846, -0.5804741382598877, 
    0.25795355439186096, 0.2856193482875824, 0.12199889868497849, -0.17827002704143524, 
    0.484037309885025, 0.12367932498455048, -0.11569387465715408, -0.1052461713552475, 
    0.19194258749485016, 0.22401583194732666, -0.1515066772699356, 0.06822885572910309, 
    0.11483331769704819, -0.18348407745361328, 0.21632599830627441, -0.44647911190986633, 
    -0.1342283934354782, -0.00791280996054411, -0.11312893033027649, -0.29017558693885803, 
    0.2966972887516022, -0.06265823543071747, 0.21474887430667877, 0.09763216227293015, 
    0.2907247841358185, -0.6948086023330688, -0.047047797590494156, -0.2766041159629822, 
    -0.5115163326263428, -0.08565251529216766, -0.07478196173906326, -0.3570287227630615, 
    0.1938968300819397, -0.1685785949230194, 0.2990546226501465, -0.21258291602134705, 
    -0.40186575055122375, 0.1495063602924347, 0.36478325724601746, 0.4987630248069763, 
    0.15168243646621704, 0.3117895722389221, -0.4024660885334015, 0.09568655490875244, 
    -0.018543006852269173, -0.03540514409542084, -0.19138260185718536, 0.09716692566871643, 
    0.4691919982433319, -0.005709407851099968, 0.2194540798664093, 0.24965694546699524, 
    0.10533440113067627, 0.03802894800901413, 0.13999991118907928, 0.288816899061203, 
    0.14613096415996552, -0.2638738453388214, 0.16009418666362762, 0.06459787487983704, 
    -0.2773503363132477, 0.3074165880680084, 0.23080594837665558, -0.22018210589885712, 
    -0.23052965104579926, -0.021219825372099876, -0.2705448865890503, 0.16300536692142487, 
    -0.3341175317764282, -0.008631858974695206, 0.6290932893753052, 0.20072050392627716, 
    -0.14753714203834534, -0.4148634076118469, -0.245106503367424, -0.113032266497612, 
    0.3672845661640167, 0.06270285695791245, 0.2731257975101471, 0.09129627794027328, 
    -0.3512328565120697, 0.12742072343826294, 0.5075588226318359, 0.06788984686136246, 
    -0.04113248363137245, -0.35355228185653687, -0.43942639231681824, 0.39308521151542664, 
    -0.12797361612319946, 0.43343228101730347, 0.24471516907215118, 0.23857393860816956, 
    -0.7203608751296997, 0.4232015907764435, 0.01754731684923172, 0.44339391589164734, 
    -0.023302320390939713, 0.09321341663599014, 0.08801113069057465, -0.15953244268894196, 
    0.05067089572548866, 0.3686598539352417, 0.20883353054523468, 0.4090155065059662, 
    -0.5373212695121765, 0.12910602986812592, -0.07708946615457535, -0.39743709564208984, 
    0.19988514482975006, -0.19079707562923431, -0.17239277064800262, -0.15110930800437927, 
    -0.07220760732889175, -0.03222734481096268, 0.12053369730710983, 0.09635310620069504, 
    -0.0977480486035347, 0.5702174305915833, 0.2832246720790863, 0.059758372604846954, 
    0.32726994156837463, 0.4881228804588318, -0.3055059015750885, 0.025027917698025703, 
    -0.3897014260292053, 0.38992148637771606, 0.5279374718666077, 0.04226063936948776, 
    -0.614316463470459, 0.16532562673091888, 0.2372739613056183, 0.18260018527507782, 
    0.013135605491697788, -0.3809245526790619, -0.20972393453121185, 0.30508026480674744, 
    0.31621190905570984, 0.05920599400997162, 0.15211285650730133, -0.24635905027389526, 
    0.04075794667005539, -0.2411343902349472, 0.03493276610970497, 0.27576300501823425, 
    0.09346550703048706, -0.13178107142448425, 0.2041458934545517, 0.21123932301998138, 
    -0.021372372284531593, 0.060789939016103745, 0.05205949395895004, -0.12068737298250198, 
    0.10015267878770828, 0.09373565763235092, -0.09990449994802475, 0.3842931389808655, 
    0.2537137269973755, -0.11040089279413223, 0.31108927726745605, 0.10055612772703171, 
    -0.5856719613075256, -0.07854481041431427, -0.5989688634872437, 0.13598915934562683, 
    0.4113696813583374, -0.17960187792778015, 0.07512679696083069, 0.12390122562646866, 
    0.43958574533462524, 0.34343570470809937, 0.05505931004881859, 0.08758897334337234, 
    -0.5898058414459229, -0.13241861760616302, 0.056584447622299194, -0.4180724322795868, 
    -0.19758127629756927, 0.3243609368801117, -0.13618704676628113, -0.5517549514770508, 
    -0.046659573912620544, 0.11784859001636505, -0.36527955532073975, -0.04339497163891792, 
    -0.04022948071360588, -0.16274061799049377, -0.2361311912536621, -0.32825127243995667, 
    -0.2306629866361618, -0.014919089153409004, -0.24854357540607452, 0.2922917306423187, 
    -0.34488898515701294, -0.3788139224052429, 0.3886393904685974, 0.033929746598005295, 
    -0.2628486454486847, -0.4100764989852905, 0.19498535990715027, -0.5500845909118652, 
    0.09669496864080429, -0.18448981642723083, -0.020455969497561455, -0.47190430760383606, 
    0.015844246372580528, -0.03665205091238022, 0.019934071227908134, 0.41381242871284485, 
    -0.1626017540693283, -0.14137648046016693, -0.41516533493995667, 0.32948318123817444, 
    0.17755314707756042, 0.07196445763111115, 0.09235499054193497, -0.07658424973487854, 
    0.15847934782505035, 0.2520291209220886, -0.00026379115297459066, -0.04514642059803009, 
    -0.3548416793346405, -0.3219315707683563, 0.3677781820297241, -0.32302847504615784, 
    0.04085823521018028, 0.21197566390037537, 0.31612032651901245, 0.22491198778152466, 
    0.0021634246222674847, 0.9700532555580139, -0.033580560237169266, 0.3537062108516693, 
    -0.008152715861797333, 0.13731200993061066, 0.21316249668598175, -0.5817225575447083, 
    -0.5554565191268921, 0.35777920484542847, 0.11687028408050537, -0.3934990167617798, 
    0.03660688176751137, -0.21539470553398132, 0.13343259692192078, 0.3721570074558258, 
    -0.11147961020469666, -0.4016972780227661, 0.2648400664329529, 0.24874944984912872, 
    -0.0018460035789757967, 0.5335388779640198, -0.029692819342017174, -0.06952372938394547, 
    -0.03008227050304413, 0.548256516456604, 0.5569800734519958, 0.1292439103126526, 
    0.3056473731994629, 0.20378686487674713, -0.02085484378039837, -0.23206369578838348, 
    -0.23557037115097046, -0.2898795008659363, 0.7030115127563477, 0.07470649480819702, 
    -0.07646898925304413, 0.34657853841781616, -0.033319201320409775, 0.15852810442447662, 
    0.3032984137535095, 0.06195114925503731, 0.03126184269785881, -0.03209848329424858, 
    0.2621026337146759, -0.11301816254854202, 0.5188112258911133, 0.013689852319657803, 
  
    };
    static const float mov_mean[] ={
    7.5134501457214355, -1.7339591979980469, 6.06900691986084, -2.817610740661621, -8.384271621704102, 
    -7.459438800811768, -6.539361953735352, -1.9556410312652588, 6.629706859588623, 
    -0.24050040543079376, 1.381696105003357, -0.2303583323955536, 4.181575298309326, 
    -5.35079288482666, -11.320425987243652, 3.5759615898132324, -8.592747688293457, 
    -4.546358585357666, 0.41044390201568604, 13.61161994934082, 3.8309175968170166, 
    2.931701183319092, 5.948641300201416, 4.721095085144043, -5.715681076049805, -4.792868614196777, 
    2.111840009689331, 0.17670591175556183, -1.7348600625991821, -0.0444413423538208, 
    0.28334149718284607, 8.549018859863281, -4.271474361419678, 3.3146450519561768, 
    -0.24194549024105072, -1.0668789148330688, 1.0936921834945679, 10.20838451385498, 
    -9.259040832519531, -11.360151290893555, 7.224193096160889, -2.3707168102264404, 
    -5.633814334869385, -12.458465576171875, 7.668046951293945, 3.027940034866333, 7.240786552429199, 
    5.059853553771973, -2.6298539638519287, 1.3176069259643555, 3.2955739498138428, 
    2.0460104942321777, 5.932052135467529, -4.534241199493408, -0.5648525953292847, 
    -5.822941780090332, 4.833570957183838, -3.9787001609802246, -1.3201898336410522, 
    0.8047229051589966, 6.294307708740234, 0.04845394939184189, 4.273715972900391, -9.278515815734863, 
    -5.4500732421875, -9.591712951660156, -1.8357881307601929, -4.0186309814453125, 
    4.659858226776123, 3.340268135070801, -5.629462718963623, 2.5940191745758057, -3.335887908935547, 
    -10.631448745727539, -2.3801722526550293, -7.2360148429870605, -6.023007869720459, 
    3.2353808879852295, -0.06006915122270584, 1.1593639850616455, 6.5510573387146, -9.599563598632812, 
    4.590837478637695, -7.883270740509033, -1.2417560815811157, -2.2049481868743896, 
    3.5383713245391846, 8.24459171295166, 1.8918766975402832, 0.8360080122947693, 2.8698084354400635, 
    -4.238772869110107, 10.136914253234863, 1.4690508842468262, -3.8787174224853516, 
    -3.3936614990234375, 0.9441192150115967, -3.387502908706665, 8.091836929321289, 
    -3.6019246578216553, 4.010341167449951, -3.3716118335723877, 1.9017448425292969, 
    -0.13598068058490753, 0.8287398219108582, -4.479969501495361, -1.404994249343872, 
    -2.8698208332061768, 1.8251768350601196, -3.846102476119995, 3.680713176727295, 
    -4.3807454109191895, -5.121235370635986, 5.756005764007568, -5.591242790222168, 
    2.7915332317352295, -9.02672290802002, -0.10704459249973297, -5.868849277496338, 
    -0.8526929616928101, 10.723008155822754, -1.405014991760254, 9.127281188964844, 
    -6.043415069580078, 0.3624245226383209, -3.0937652587890625, -5.647485256195068, 
    -0.6213083267211914, -1.8909242153167725, -1.870800495147705, 0.5815063118934631, 
    4.111344337463379, -7.45107364654541, 9.162976264953613, -6.013865947723389, -2.676823616027832, 
    1.6559255123138428, 2.6650633811950684, -0.6542558670043945, -3.113373279571533, 
    1.691332459449768, -2.1427505016326904, -10.442635536193848, 0.49528932571411133, 
    -8.482518196105957, -1.8277133703231812, -3.9649107456207275, 0.865470290184021, 
    11.204797744750977, -10.304442405700684, -0.3287913501262665, -4.300971031188965, 
    -1.0004345178604126, -5.528252601623535, -0.7210570573806763, -2.6789934635162354, 
    -10.105842590332031, 2.0438051223754883, 0.16669192910194397, -8.065009117126465, 
    0.649267852306366, -0.7782547473907471, -0.8332673907279968, 5.491363048553467, 
    4.55661678314209, 7.818807125091553, 4.559535980224609, 4.780961990356445, -5.032003879547119, 
    3.3442299365997314, -1.7896881103515625, -8.090681076049805, 5.793532848358154, 
    1.5401349067687988, -1.9830129146575928, -4.386358737945557, -4.472772121429443, 
    -0.7223927974700928, -11.577735900878906, -1.0491361618041992, 0.25625747442245483, 
    1.2865465879440308, 1.2232773303985596, -4.523726463317871, 8.262412071228027, 11.516201972961426, 
    3.5802361965179443, -3.9898338317871094, -5.191483020782471, -3.204586982727051, 
    8.473533630371094, -0.21129955351352692, -4.676422119140625, 5.1296491622924805, 
    -7.21983528137207, -7.053872108459473, -3.960975408554077, 1.9290064573287964, -6.641571998596191, 
    -8.381731986999512, -11.810394287109375, -1.1764940023422241, 5.90995454788208, 
    7.678150177001953, 5.575512886047363, 4.606457233428955, 1.0661120414733887, 7.534441947937012, 
    -2.7106311321258545, 0.8343802094459534, 4.413505554199219, -3.520493745803833, 
    2.1014597415924072, -3.697195529937744, 3.83325457572937, 1.7234032154083252, -2.038437604904175, 
    14.731456756591797, 5.966891765594482, -2.917309284210205, -8.144004821777344, 4.926769256591797, 
    1.2256968021392822, -1.8723692893981934, 2.2037312984466553, -0.5775350332260132, 
    5.033868789672852, 3.8758866786956787, 3.651541233062744, 5.787080764770508, -8.798192024230957, 
    3.066661834716797, 1.6710745096206665, -1.0114871263504028, 8.695928573608398, -2.6057724952697754, 
    9.61535930633545, -6.177772521972656, 7.675440788269043, 2.3645620346069336, -1.809583306312561, 
    9.049217224121094, 4.925934314727783, -5.31380033493042, 7.621211528778076, -2.3583157062530518, 
    2.807096481323242, 5.899874687194824, 0.19882522523403168, 2.120253086090088, 5.2579450607299805, 
    -0.05830114334821701, -4.524710178375244, -5.967572212219238, -2.052915573120117, 
    2.523608446121216, 8.510181427001953, 0.5904198288917542, 1.6953742504119873, -5.501804828643799, 
    -2.604642391204834, 1.4985558986663818, -5.135472774505615, 2.7327589988708496, 
    -4.721548080444336, 3.9336800575256348, -6.919010639190674, 3.156869411468506, -5.2375993728637695, 
    3.493845224380493, 7.066587924957275, 4.647985935211182, -3.110531806945801, -2.1318182945251465, 
    -2.4924814701080322, -0.9458442330360413, -3.9023308753967285, -6.357635021209717, 
    -0.8081197142601013, -11.062549591064453, 1.7005741596221924, 0.2954499125480652, 
    -0.5981342196464539, 3.499047040939331, 2.9918010234832764, 2.091324806213379, 7.651162147521973, 
    3.1513116359710693, -0.8793954253196716, -3.1993608474731445, -3.6212289333343506, 
    -2.9089791774749756, -8.540619850158691, -1.0568958520889282, -5.287859916687012, 
    -4.770269393920898, -0.9589318633079529, -1.3417668342590332, 0.5069825649261475, 
    -3.6872689723968506, -6.842172622680664, 5.584604740142822, -2.325237274169922, 
    -0.47208064794540405, 3.4009716510772705, 2.73747181892395, 10.004645347595215, 
    -0.676375687122345, 2.6312389373779297, 1.9558007717132568, 4.205219745635986, 3.791170835494995, 
    -7.041755676269531, 0.16930200159549713, -3.2028753757476807, 0.5312789678573608, 
    6.36541748046875, 1.5260201692581177, -3.831824541091919, -8.826534271240234, -1.5786266326904297, 
    6.3843607902526855, -6.975495338439941, 12.992021560668945, 2.907538652420044, 9.029805183410645, 
    4.574963092803955, 0.9883208870887756, -5.751040935516357, 3.7097654342651367, 5.562915325164795, 
    3.1555259227752686, 7.383411884307861, -4.600107669830322, -0.8445016145706177, 
    -4.1014933586120605, -11.456127166748047, -0.6126289963722229, 3.0586352348327637, 
    -3.282881736755371, -2.2205440998077393, 2.6041762828826904, -9.303390502929688, 
    -3.125941276550293, -9.245987892150879, -6.672393798828125, 6.333338260650635, 3.9225518703460693, 
    3.310563564300537, 3.9034945964813232, -0.3650619089603424, -6.418918609619141, 
    -3.7767341136932373, 4.730480194091797, -4.152275085449219, -3.3363146781921387, 
    5.8461079597473145, -2.3512489795684814, 3.564490795135498, -4.13009786605835, -1.938750982284546, 
    6.9363532066345215, -2.312906265258789, 0.3474694490432739, -5.761781215667725, 
    14.592692375183105, 4.982135772705078, -1.448875904083252, 0.4491952061653137, -17.866212844848633, 
    -2.513061046600342, 6.242727756500244, -4.063590049743652, -0.6937034130096436, 
    -2.328233003616333, 4.111909866333008, -0.771020770072937, 1.6374378204345703, 0.0914643332362175, 
    -6.549644947052002, -2.850569486618042, 7.899288177490234, -9.431077003479004, 5.925894737243652, 
    12.690864562988281, -6.6189117431640625, -7.259268760681152, 4.964230060577393, 
    1.661494255065918, 8.493638038635254, -4.855736255645752, -3.862579345703125, -1.4162027835845947, 
    -6.321619033813477, -2.0125606060028076, 0.3740736246109009, 7.7047119140625, -6.384918212890625, 
    -0.775137722492218, 1.761130690574646, 1.1840481758117676, 3.570509910583496, -2.6115882396698, 
    -0.23550385236740112, -11.382547378540039, -1.7347896099090576, 9.128868103027344, 
    -4.671192646026611, -0.4363400638103485, -3.5757477283477783, 5.002533912658691, 
    3.4867537021636963, -11.106292724609375, 1.7253142595291138, 8.036701202392578, 
    -4.329737663269043, -0.7659443616867065, 7.268942832946777, 2.131551504135132, -3.216249465942383, 
    7.084052085876465, -9.879046440124512, 0.7032102942466736, -5.575997829437256, 1.1067999601364136, 
    1.1744970083236694, -1.497623085975647, 14.073264122009277, 2.3368477821350098, 
    1.3427257537841797, -8.325823783874512, -3.2703521251678467, -0.5435100197792053, 
    1.617158055305481, 9.844654083251953, -0.05490918457508087, 3.3130950927734375, 
    -7.027000904083252, -3.1640617847442627, -6.108077049255371, -1.6682379245758057, 
    -0.03578783944249153, 11.075277328491211, 0.5085819363594055, -6.067569255828857, 
    -2.554088592529297, -0.22450730204582214, -0.6622583866119385, 0.8427939414978027, 
    5.0852861404418945, 3.5546653270721436, -4.682445526123047, 0.4703221023082733, 
    2.194960117340088, 5.153270721435547, -4.889134407043457, -2.1175317764282227, 10.01378345489502, 
    -5.044251441955566, -3.8114240169525146, -0.36777737736701965, 2.402082681655884, 
    0.1920432597398758, -1.9488195180892944, -9.585603713989258, 4.168910980224609, 
    0.6127646565437317, -3.7107114791870117, 2.240006685256958, 7.249765872955322, 1.1391386985778809, 
    -6.912237167358398, -1.788494348526001, -4.7453694343566895, 0.5310763716697693, 
    11.28689193725586, 4.96701717376709, -1.572636604309082, -3.703158378601074, 0.4512152075767517, 
    5.36964225769043, 10.226728439331055, -0.2584134638309479, 2.249462604522705, -2.5207271575927734, 
    -2.5674567222595215, 1.6815277338027954, 15.537285804748535, 1.0844160318374634, 
    3.960268974304199, -2.139799118041992, 6.135177135467529, 8.539069175720215, -0.24619337916374207, 
    -13.500643730163574, 4.327054977416992, -4.696512222290039, 1.5988152027130127, 
    4.7203779220581055, 10.20782470703125, -3.9548656940460205, -2.4976322650909424, 
    -2.8298017978668213, -8.244673728942871, 4.590651512145996, -1.6094410419464111, 
    1.7532784938812256, 7.899911403656006, -9.82553768157959, 1.336646556854248, 2.3871049880981445, 
    2.830867052078247
    };
    static const float inv_gamma_dev[] ={
    ...
    static const batch_normalization_layer_t norm = { 512, beta, mov_mean, inv_gamma_dev };
    return norm;
}
