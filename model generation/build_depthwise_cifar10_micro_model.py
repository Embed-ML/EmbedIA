...
model.add(layers.Input((IH,IW,3)))  # DepthwiseConv2D Layer
model.add(layers.DepthwiseConv2D((2, 2), activation='relu'))  # DepthwiseConv2D Layer
model.add(layers.Conv2D(1,(2, 2), activation='relu'))  # xConv2D Layer
#model.add(layers.DepthwiseConv2D((2, 2), activation='relu'))  # DepthwiseConv2D Layer
...
SAMPLES_FILE = f'cifar10_20samples_{IW}x{IH}.sav'
model.save(f'cifar10_depthwise_micro_model_{IW}x{IH}.h5')
