...
/**
 * @file realtype.h
 * @brief Data type definitions and macro operations for FIXED16 type (ESP32 optimized)
 * 
 ...
 * 
 * NOTE: FIXED16 serves as the base for 16-bit fixed-point arithmetic.
 */
...
#define DATA_TYPE_NAME  "FIXED16"     /**< Human-readable type name */


/* ========================================================================
 * FIXED16 CONFIGURATION
 * ======================================================================== */
 ...
 * 
 * Current configuration: FIXED16 (ESP32 optimized)
 * ======================================================================== */
 ...
 * For FIXED16: 16-bit fixed-point (Q7.8 or configurable)
 */
 ...
 * For FIXED16: 32-bit fixed-point (Q15.16 or configurable)
 */
...
#define ST2CO(s, qp)     (s)                       /**< Load weight: fixed16 → fixed16 (no-op) */
#define CO2ST(c, qp)     (c)                       /**< Store result: fixed16 → fixed16 (no-op) */

// Compute ↔ ComputeX (precision promotion/demotion)
#define CO2CX(c)         FX2DFX(c)                 /**< Promote: fixed16 → fixed32 */
#define CX2CO(cx)        DFX2FX(cx)                /**< Demote: fixed32 → fixed16 */
...
// Storage limits
#define STORAGE_MAX      FIX_MAX       /**< Maximum storage value (fixed16) */
#define STORAGE_MIN      FIX_MIN       /**< Minimum storage value (fixed16) */

// Compute limits
#define COMPUTE_MAX      FIX_MAX       /**< Maximum compute value: 32767/256 ≈ 127.996 */
#define COMPUTE_MIN      FIX_MIN       /**< Minimum compute value: -32768/256 = -128.0 */
#define COMPUTEX_MAX     DFIX_MAX      /**< Maximum computex value: 2147483647/65536 ≈ 32767.999 */
#define COMPUTEX_MIN     DFIX_MIN      /**< Minimum computex value: -2147483648/65536 = -32768.0 */
...
// Storage constants
#define STORAGE_ZERO     FIX_ZERO      /**< Zero value (fixed16) */

// Compute constants
#define COMPUTE_ZERO     FIX_ZERO      /**< Zero value: 0 */
#define COMPUTE_ONE      FIX_ONE       /**< Unity value: 256 (represents 1.0) */
#define COMPUTE_TWO      FIX_TWO       /**< Two value: 512 (represents 2.0) */
#define COMPUTE_HALF     FIX_HALF      /**< Half value: 128 (represents 0.5) */
