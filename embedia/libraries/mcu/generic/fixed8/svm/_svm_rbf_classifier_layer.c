/**
 * @brief Performs SVM classification using RBF (Radial Basis Function) kernel (8-bit fixed-point).
 *
 ...
 * support vectors and one-vs-one voting strategy with 8-bit fixed-point arithmetic.
 *
