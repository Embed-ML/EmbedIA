...
/**
 * @file realtype.h
 * @brief Data type definitions and macro operations for QUANT8 type
 * 
...
#define DATA_TYPE_NAME  "QUANT8_FIXED16"     /**< Human-readable type name */
 ...
 * For QUANT8: 8-bit quantized integers
 */
 ...
 * For QUANT8: 16-bit fixed-point (Q8.8)
 */
 ...
 * For QUANT8: 32-bit fixed-point (Q16.16)
 */
...
// Storage ↔ Compute (quantization domain)
#define ST2CO(s, qp)     DEQUANTIZE_FIXED(s, qp)    /**< Load weight: int8 → fixed16 */
#define CO2ST(c, qp)     QUANTIZE_FIXED(c, qp)      /**< Store result: fixed16 → int8 */

// Compute ↔ ComputeX (precision domain)
...
// Storage limits
#define STORAGE_MAX      127          /**< Maximum storage value (int8) */
#define STORAGE_MIN      (-128)       /**< Minimum storage value (int8) */
...
// Storage constants
#define STORAGE_ZERO     0            /**< Zero value (int8) */
