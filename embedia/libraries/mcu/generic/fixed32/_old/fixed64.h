...
#define DFIXED_DDIV(A,B) \
    ((dfixed)((((int64_t)(A) << FIX_DFRC_SZ) + ((int64_t)(B) >> 1)) / (int64_t)(B)))
...
#define FIXED_DIV_INT(A, B) \
    ((fixed)((((int64_t)(A) << FIX_FRC_SZ) + ((int32_t)(B) >> 1)) / (int32_t)(B)))
...
#define CLAMP_DFX_TO_FX(X, MIN, MAX) ((X<FX2DFX(MIN))?MIN:((X>FX2DFX(MAX))?MAX:DXF2FX(X)))
