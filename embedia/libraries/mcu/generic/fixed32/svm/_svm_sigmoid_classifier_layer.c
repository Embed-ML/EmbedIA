/**
 * @brief Performs SVM classification using sigmoid kernel with sparse representation (fixed-point).
 *
 ...
 * one-vs-one voting using sparse support vectors with fixed-point arithmetic.
 *
