...
PROJECT_NAME = 'Prj-cifar10-DepthWiseConv2D_Net_micro_Q8'
# MODEL_FILE = 'models/MNIST_14x14_model.h5'
MODEL_FILE = 'models/cifar10_depthwise_micro_model_4x4.h5'

SAMPLES_FILE = 'samples/cifar10_20samples_4x4.sav'

#model = load_model(MODEL_FILE)
model = ModelLoader.load_model(MODEL_FILE)

model._name = "cifar10_model_dpw_micro"
