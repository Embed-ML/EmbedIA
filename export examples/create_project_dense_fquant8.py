...
# el modelo esta creado con ReLU como Clase y deberia estar como string 'relu' para que se pueda leer directamente
model = load_model(MODEL_FILE, custom_objects={'ReLU': ReLU})
